...
- **Contexto:** El problema se encuentra en Santa Cruz de la Sierra, con una demanda de 20,000 usuarios activos que requieren disponibilidad de servicio las 24 horas y flexibilidad en las formas de pago y entrega.

<a id="dolor-o-necesidad"></a>
...
- **Falta de control logístico:** El desorden en las rutas y la ausencia de evidencias fotográficas provocan desconfianza en los clientes y posibles pérdidas de productos.
- **Incertidumbre en el cliente:** La falta de estados claros (recibido, enviado, etc.) genera ansiedad, estrés y consultas constantes al soporte.
- **Dificultad administrativa:** Procesos manuales para devoluciones y reportes consumen tiempo y aumentan el riesgo de errores en facturación e inventario.

<a id="alcance-del-sistema"></a>
...
- **Módulo de logística/transporte:** Aplicación para choferes con registro de rutas y captura de evidencia fotográfica.
- **Gestión de pedidos:** Flujo de estados (6 estados desde recibido hasta entregado) y confirmación por parte del usuario.
- **Control administrativo:** Manejo de inventarios, reportes y sistema de devoluciones.
- **Métodos de entrega:** Delivery o recojo en almacén.

#### Qué NO va a resolver

- **Ventas nacionales/internacionales:** El sistema está restringido a la ciudad de Santa Cruz de la Sierra.
- **Fabricación de productos:** No incluye procesos de fabricación.
...
- **Tipo de prioridad:** Alta
- **Historia:** Como cliente, quiero visualizar en tiempo real los 6 estados de mi pedido (recibido, en proceso, enviado, trasladándose, listo para entregarse, entregado) para reducir la ansiedad y estrés sobre el tiempo de llegada de mi compra.
- **Criterios de aceptación:**
  ...
  - Dado que el pedido llega al estado "Listo para entregarse", cuando el sistema detecte el cambio, entonces debe enviar una notificación automática al usuario.
- **Estimación:** +2 días
...
- **Criterios de aceptación:**
  ...
  - Dado que el stock de un producto llega a cero, cuando un cliente intente agregarlo al carrito, entonces el sistema debe mostrar un mensaje de "Producto Agotado" y deshabilitar el botón de compra.
- **Estimación:** +4 días
...
- **Tipo de prioridad:** Alta
- **Historia:** Como administrador, quiero categorizar y gestionar los productos (ver, crear, editar, eliminar) para que el catálogo sea igual a lo que está en el almacén.
- **Criterios de aceptación:**
...
- **Criterios de aceptación:**
  - Dado que un cliente envío una solicitud de devolución (HU-03), cuando el administrador la revise, entonces debe poder ver la foto de la factura y el motivo de la devolución.
...
- **Tipo de prioridad:** Alta
- **Historia:** Como cliente, quiero filtrar los productos por precio, categoría y disponibilidad para encontrar rápidamente lo que quiero comprar.
- **Criterios de aceptación:**
...
- **Criterios de aceptación:**
  - Dado que el cliente está en su perfil, cuando entre a "Mis Compras", entonces debe ver una lista de todos sus pedidos con sus respectivos estados.
